...
const Search = ({ content }: { content: Content[] }) => {
  ...
  const isContents = !isAccounts ? "border-b-2 border-black" : "text-gray-400";
  ...
  return (
    <div className="w-full  ">
      <div className="flex gap-10 mb-10 border-b-2 border-gray-200 md:fixed z-50 bg-white w-full">
        ...
        <p
          className={`text-xl font-semibold cursor-pointer ${isContents} mt-2`}
